...
grails.plugin.springsecurity.userLookup.userDomainClassName = 'com.ybg.rp.partner.partner.PartnerUserInfo'
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'com.ybg.rp.partner.partner.PartnerUserAuthority'
grails.plugin.springsecurity.auth.loginFormUrl = '/login/form'
grails.plugin.springsecurity.authority.className = 'com.ybg.rp.partner.partner.PartnerAuthorityInfo'
